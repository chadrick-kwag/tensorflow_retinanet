...
from object_detection import np_argmax_matcher as argmax_matcher
# from object_detection import np_box_list as box_list
from object_detection import np_faster_rcnn_box_coder as faster_rcnn_box_coder
from object_detection import np_region_similarity_calculator as region_similarity_calculator
from object_detection import np_target_assigner as target_assigner
...
class Anchor():
    ...
    def _generate(self):
        ...
        for feature_shape, grid_info in zip(self._feature_map_shape_list, self._anchor_grid_info):
            ...
            print("box_corners:{}".format(box_corners))

            anchor_grid_list.append(box_corners)
        print("anchor_grid_list size:{}".format(len(anchor_grid_list)))
        return np.concatenate(anchor_grid_list, axis=0)
